...
#import "BlockUI_nova.h"
  ...
  #define kActionSheetFirstButtonMargin   5
  ...
  #define kActionSheetButtonPrefix            @"action-"
  ...
  #define kAlertViewTitleMargin    10
  ...
  #define kAlertButtonPrefix              @"alert-"
